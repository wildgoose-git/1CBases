...
Процедура СоставРаботПериодПриИзменении(Элемент)
	...
	LogBookОбщегоНазначенияКлиент.ЗаполнитьДатыИзПериода(ТекущиеДанные.Период,ТекущиеДанные.ДатаНачала,ТекущиеДанные.ДатаОкончания);
...
Процедура ЗаполнитьСлужебныеРеквизиты()
	...
	Для каждого СтрокаТаблицы Из Объект.СоставРабот Цикл
		LogBookОбщегоНазначенияКлиент.ЗаполнитьПериодИзДаты(СтрокаТаблицы.Период,СтрокаТаблицы.ДатаНачала,СтрокаТаблицы.ДатаОкончания);
	КонецЦикла;
